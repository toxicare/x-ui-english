...
A furthur development from [my previous repo](https://github.com/toxicare/x-ui-english.old) and
...
````
bash <(curl -Ls https://raw.githubusercontent.com/toxicare/x-ui-english/master/install.sh)
````
...
cd
````
2. Then download the latest compressed package from https://github.com/toxicare/x-ui-english/releases/latest, generally choose `amd64` architecture
...
**If it is a fresh installation, these functions, specially IP limiting, will work flowlessly. But if yours is an upgrading, they miight not work while giving XRAY status : not running. In such cases, please refer [here](https://github.com/toxicare/x-ui-english/discussions/27)**
